				...
				if (//(boardState[settlementRowCol[i][0]-1][settlementRowCol[i][1]].player === currPlayer ||
					...
					case PlayerEnum.ONE:
						if (RemainingHutsEnum.ONE > 0) {
							...
							boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].player = currPlayer;
							if (RemainingHutsEnum.ONE >= boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].level) {
					...
					case PlayerEnum.TWO:
						if (RemainingHutsEnum.TWO > 0) {
							// If player has huts left to build:
							boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].player = currPlayer;
							if (RemainingHutsEnum.TWO >= boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].level) {
								// If player has enough huts, levels, else rest:
								boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].huts = 
									boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].level;
					...
					case PlayerEnum.THREE:
						if (RemainingHutsEnum.THREE > 0) {
							// If player has huts left to build:
							boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].player = currPlayer;
							if (RemainingHutsEnum.THREE >= boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].level) {
								// If player has enough huts, levels, else rest:
								boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].huts = 
									boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].level;
					...
					case PlayerEnum.FOUR:
						if (RemainingHutsEnum.FOUR > 0) {
							// If player has huts left to build:
							boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].player = currPlayer;
							if (RemainingHutsEnum.FOUR >= boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].level) {
								// If player has enough huts, levels, else rest:
								boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].huts = 
									boardState[settlementRowCol[i][0]+rowOffset][settlementRowCol[i][1]+colOffset].level;
